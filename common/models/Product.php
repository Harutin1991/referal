...
class Product extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['name', 'description', 'category_id', 'rate', 'art_no', 'weight', 'route_name'], 'required'],
            [['description', 'route_name'], 'string'],
            [['status', 'category_id', 'rate', 'weight', 'brand_id'], 'integer'],
            [['price', 'price_start', 'price_end'], 'number'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'price_start' => Yii::t('app', 'Price Start'),
            'price_end' => Yii::t('app', 'Price End'),
