...
<div class="tr-works-form">
    ...
    <div class="panel sort-disable mb50" id="p2" data-panel-color="false" data-panel-fullscreen="false"
        ...
        <div class="panel-heading">
            <span class="panel-title"><label style="font-size: 25px; color:#0a0e1b">Event Name: <?= $model->event->title; ?></label></span>
        </div>
        ...
        <div class="panel-body" style="display: block;">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <?=
                                ...
                                ->textInput(['maxlength' => true, 'placeholder' => Yii::t('app', 'Events Name')])->label(false);
                        ?>
                    </div>
                </div> 
            ...
            CKEDITOR.replace('trevents-short_description');
            CKEDITOR.replace('trevents-description');
"); ?>
        </div>
    </div>
</div>
