...
if (!$model->isNewRecord) {
    $formId = 'eventsUpdate';
    $action = '/events/update?id=' . $model->id;

    $defaultImage = Files::getDefaultImageIdByProductId($model->id, 'events');
} else {
    $formId = 'eventsCreate';
...
<div class="categoyr-form">
    <?= Html::a('Back to events list', ['/events/index'], ['class' => 'btn btn-primary mb15']) ?>
    <div class="panel sort-disable mb50" id="p2" data-panel-color="false" data-panel-fullscreen="false" data-panel-remove="false" data-panel-title="false">
        <div class="panel-heading">
            <span class="panel-title"><?php echo Yii::t('app', 'Add New event') ?></span>
            ...
            <ul class="nav panel-tabs-border panel-tabs">
                ...
                if (!$model->isNewRecord) {
                    foreach ($languages as $value):
                        ...
                        ?>">
                            <a href="#tab_<?php echo $value['id'] ?>"  data-toggle="tab" onclick="editEventsTr(<?php echo $value['id']; ?>,<?php echo $model->id; ?>,<?php echo $value['is_default']; ?>)" disabled="disabled">
        ...
        <div class="panel-body"  style="display: block;">
            <div class="tab-content pn br-n admin-form">
                <div class="tab-pane" id="tr_events"></div>
                    ...
                    <div class="tab-content row">
                        <div class="col-md-4">
                            <?=
                                    ...
                                    ->textInput(['maxlength' => true, 'placeholder' => Yii::t('app', 'Event Name')])->label(false)
                            ?>
                        </div>
                        <div class="col-md-4">
                            <?=
                                            ...
                                            <?php foreach ($imagePaths as $key => $imagePath): ?>
                                                <div style="display: inline-block;"
                                                    ...
                                                    <div class="panel p6 pbn">
                                                        <div class="of-h">
                                                            <?php
                                                            echo Html::img('/uploads/images/events/'.$model->id.'/' . $imagePath['path'], [
                                                            ...
                                                            <div class="row table-layout change_image"
                                                                ...
                                                                <input type="hidden" value="events" id="category">
...
<?php echo $this->registerJs("
            CKEDITOR.replace('events-short_description');
            CKEDITOR.replace('events-description');
"); ?>
<?php
$this->registerJs("
$('#events-title').on('focusout',function(){
