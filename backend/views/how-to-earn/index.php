...
<div class="row">
    <div class="col-md-12">
        <div class="slider-index">
            <?= Html::a('<span class="fa fa-plus pr5"></span>' . Yii::t('app', 'Create New How To Earn'), ['/how-to-earn/create'], ['class' => 'btn btn-system mb15']) ?>
        </div>
        <!-- recent orders table -->
                            ...
                            'columns' => [
                                ['attribute' => 'image',
                                    ...
                                    'value' => function ($model) {
                                        ...
                                        if (isset($image[1])) {
                                            $path = 'uploads/images/how_to_earn/' . $model->id . '/thumbnail/' . $image[1];
                                        } else {
