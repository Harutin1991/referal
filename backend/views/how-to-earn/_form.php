...
if (!$model->isNewRecord) {
    $formId = 'howToEarnUpdate';
    $action = '/how-to-earn/update?id=' . $model->id;
    $tr_action = 'tr-how-to-earn/update'.$model->id;
    $tr_formId = 'TrhowToEarnUpdate';
    $defaultImage = Files::getDefaultImageIdByProductId($model->id, 'how_to_earn');
} else {
    $formId = 'howToEarnCreate';
    $action = '/how-to-earn/create';
    $tr_action = 'tr-how-to-earn/create';
    $tr_formId = 'TrhowToEarnCreate';
}
?>
<div class="row">
    <div class="col-lg-12">
        ...
        <div  class="tab-content mar-top">
                                                                    ...
                                                                    <?php foreach ($imagePaths as $key => $imagePath): ?>
                                                                        <div style="display: inline-block;"
                                                                            ...
                                                                            <div class="panel p6 pbn">
                                                                                <div class="of-h">
                                                                                    <?php
                                                                                    echo Html::img('/uploads/images/how_to_earn/' . $model->id . '/' . $imagePath['path'], [
            ...
            <?php else: ?>
                <?php
                $trmodel = TrHowToEarn::findOne(['how_to_earn_id' => $model->id, 'language_id' => $value['id']]);
                if (!$trmodel) {
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    ...
                                    <?php echo $trform->field($trmodel, 'how_to_earn_id')->hiddenInput(['value' => $model->id])->label(false); ?>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="row">
                                                <div class="panel panel-success">
