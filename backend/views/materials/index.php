...
<div class="table-layout">
    <div class="tray tray-center">
        ...
        <div id="product-form_cont">
            ...
            <?= Html::a(Yii::t('app', '<span class="fa fa-plus pr5"></span>Create Material'), ['/materials/create'], ['class' => 'btn btn-system mb15']) ?>
        </div>
        <!-- recent orders table -->
        <div class="panel">
                        ...
                        'columns' => [
                            ...
                            ['attribute' => 'image',
                                ...
                                'value' => function ($model) {
                                    ...
                                    if (isset($image[1])) {
                                        $path = 'uploads/images/materials/'.$model->id.'/thumbnail/' . $image[1];
                                    } else {
                            ...
                            ['attribute' => 'name',
                                'format' => 'html',
                                'value' => function ($model) {
                                    $url = \yii\helpers\Url::toRoute(['materials/index', 'id' => $model->id]);
