...
?>
<div class="tr-service-form">

    <?php
    $form = ActiveForm::begin([
                'action' => ['/tr-service/update'],
                'id' => 'trserviceUpdate',
    ]);
    ?>
    <div class="panel sort-disable mb50" id="p2" data-panel-color="false" data-panel-fullscreen="false"
        ...
        <div class="panel-heading">
            <span class="panel-title"><label style="font-size: 25px; color:#0a0e1b">Service Name: <?= $model->service->name; ?></label></span>
        </div>
        ...
        <div class="panel-body" style="display: block;">
            ...
            CKEDITOR.replace('trservice-short_description');
            CKEDITOR.replace('trservice-description');
"); ?>
        </div>
    </div>
</div>
