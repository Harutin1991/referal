    ...
    <div class="tr-works-form">
        ...
        <div class="panel sort-disable mb50" id="p2" data-panel-color="false" data-panel-fullscreen="false"
            ...
            <div class="panel-heading">
                <span class="panel-title"><label style="font-size: 25px; color:#0a0e1b">Work Name: <?= $model->work->name; ?></label></span>
            </div>
            ...
            <div class="panel-body" style="display: block;">
                ...
                <div class="tab-content row">
                    <div class="row">
                        <div class="col-md-6">
                            <?=
                                    ...
                                    ->textInput(['maxlength' => true, 'placeholder' => Yii::t('app', 'Work Name')])->label(false);
                            ?>
                        </div>
                    </div> 
                    ...
                    <?= $form->field($model, 'works_id')->hiddenInput()->label(false) ?>
            ...
            CKEDITOR.replace('trworks-short_description');
            CKEDITOR.replace('trworks-description');
"); ?>
            </div>
        </div>
    </div>
