...
if (!$model->isNewRecord) {
    ...
    $defaultImage = Files::getDefaultImageIdByProductId($model->id, 'partners');
} else {
...
<div class="categoyr-form">
    <?= Html::a('Back to partners list', ['/partners/index'], ['class' => 'btn btn-primary mb15']) ?>
    <div class="panel sort-disable mb50" id="p2" data-panel-color="false" data-panel-fullscreen="false" data-panel-remove="false" data-panel-title="false">
        <div class="panel-heading">
            <span class="panel-title"><?php echo Yii::t('app', 'Add New partner') ?></span>
            ...
            <ul class="nav panel-tabs-border panel-tabs">
                ...
                if (!$model->isNewRecord) {
                    foreach ($languages as $value):
                        ...
                        ?>">
                            <a href="#tab_<?php echo $value['id'] ?>"  data-toggle="tab" onclick="editPartnersTr(<?php echo $value['id']; ?>,<?php echo $model->id; ?>,<?php echo $value['is_default']; ?>)" disabled="disabled">
                ...
                <div class="tab-pane active" id="tab_<?php echo $defoultId; ?>">
                    ...
                    <div class="section row">
                        <div class="col-md-6 pt15">
                            <label><?= Yii::t('app', 'Image Size'); ?>:(320x180)</label>
                            <?=
                                            ...
                                            <?php foreach ($imagePaths as $key => $imagePath): ?>
                                                <div style="display: inline-block;"
                                                    ...
                                                    <div class="panel p6 pbn">
                                                        <div class="of-h">
                                                            <?php
                                                            echo Html::img('/uploads/images/partners/' . $model->id . '/' . $imagePath['path'], [
                                                            ...
                                                            <div class="row table-layout change_image"
                                                                ...
                                                                <input type="hidden" value="partners" id="category">
...
<?php echo $this->registerJs("
            CKEDITOR.replace('partners-short_description');
"); ?>