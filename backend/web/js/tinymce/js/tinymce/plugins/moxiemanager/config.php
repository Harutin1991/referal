...
// Filesystem
$moxieManagerConfig['filesystem.rootpath'] = "../../../../../../uploads/images/tinymce";
if (!file_exists($moxieManagerConfig['filesystem.rootpath'])) {
    mkdir($moxieManagerConfig['filesystem.rootpath'], 0777, true);
}
