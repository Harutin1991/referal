...
class CategoryController extends Controller {
    ...
    public function actionCreate() {
        if (Yii::$app->request->post()) {
            ...
            if ($category->save()) {
                ...
                if (!empty($file)) {
                    $path = Yii::getAlias("@backend/web/uploads/images/categories");
                    $pathImage = Yii::getAlias("@backend/web/uploads/images/categories/" . $category->id);
                    $directoryThumb = Yii::getAlias("@backend/web/uploads/images/categories/" . $category->id."/thumbnail");
                    ...
                    if ($file[0]->saveAs($pathImage . DIRECTORY_SEPARATOR . $name)) {
                        ...
                        $modelFiles->category_id = $category->id;
                        $modelFiles->category = "category";
                        $modelFiles->status = 1;
                        $modelFiles->top = 1;
                        $modelFiles->save();
                    }
    ...
    public function actionUpdate($id) {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            $file = UploadedFile::getInstances($modelFiles, 'path');
                if (!empty($file)) {
                    $path = Yii::getAlias("@backend/web/uploads/images/category");
                    $pathImage = Yii::getAlias("@backend/web/uploads/images/category/" . $model->id);
                    $directoryThumb = Yii::getAlias("@backend/web/uploads/images/category/" . $model->id."/thumbnail");
                    BaseFileHelper::createDirectory($path);
                    BaseFileHelper::createDirectory($pathImage);
                    BaseFileHelper::createDirectory($directoryThumb);
                    $file_ext = explode(".", $file[0]->name);
            ...
            $images = Files::find()->where(['category' => 'category', 'category_id' => $id])->asArray()->all();
            $modelFiles = new Files();
        ...
        if (Yii::$app->request->isAjax) {
            ...
            try {
                ...
                foreach ($category_ids as $id) {
                    ...
                    if (!empty($attribute)) {
                        $allow = false;
                        $forinkeys[$id]['attribute'] = $attribute;
                    }if (!empty($product)) {
                        $allow = false;
    ...
    public function actionDeleteImage() {
        if (Yii::$app->request->isAjax) {
            ...
            $directory = Yii::getAlias("@backend/web/uploads/images/category/" . $model->category_id);
            $directoryThumb = Yii::getAlias("@backend/web/uploads/images/category/" . $model->category_id . "/thumbnail");
