...
class TrProductController extends Controller {
    ...
    public function actionUpdate() {
        if (isset(Yii::$app->request->post()['TrProduct'])) {
            ...
            $model = new TrProduct();
            $Attrmodel = new TrProductAttribute();

            $arrPost = Yii::$app->request->post()['TrProduct'];
            //$arrPostAttr = Yii::$app->request->post()['ProductAttribute'];
            ...
            $attributes = $model->getAttribute($arrPost['product']);
            $tr_productObj = new TrProduct();
           // $tr_productAttrObj = new TrProductAttribute();
            //$tr_productAttr = $tr_productAttrObj->findOne(['language_id' => $arrPost['lang'], 'product_id' => $arrPost['product']]);
            ...
            echo $this->renderAjax('_form', [
             ...
             //   'product_attributes' => $attributes,
              //  'modelProductAttr' => $tr_productAttr,
            ]);
            exit();
        }
    }
