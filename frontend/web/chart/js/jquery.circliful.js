...
if (settings.text != null) {
                if (settings.halfCircle) {
                    if (settings.textBelow) {
                        elements += '<p text-anchor="middle" x="' + (settings.textX != null ? settings.textX : '100') + '" y="' + (settings.textY != null ? settings.textY : '120') + '" style="' + settings.textStyle + '" fill="' + settings.textColor + '">' + settings.text + '</p>';
                    } else if (settings.multiPercentage == 0) {
                        elements += '<p text-anchor="middle" x="' + (settings.textX != null ? settings.textX : '100') + '" y="' + (settings.textY != null ? settings.textY : '115') + '" style="' + settings.textStyle + '" fill="' + settings.textColor + '">' + settings.text + '</p>';
                    } else if (settings.multiPercentage == 1) {
                        elements += '<p text-anchor="middle" x="' + (settings.textX != null ? settings.textX : '228') + '" y="' + (settings.textY != null ? settings.textY : '65') + '" style="' + settings.textStyle + '" fill="' + settings.textColor + '">' + settings.text + '</p>';
                    }
                } else {
                    if (settings.textBelow) {
                        elements += '<p text-anchor="middle" x="' + (settings.textX != null ? settings.textX : '100') + '" y="' + (settings.textY != null ? settings.textY : '190') + '" style="' + settings.textStyle + '" fill="' + settings.textColor + '">' + settings.text + '</p>';
                    } else if (settings.multiPercentage == 0) {
                        elements += '<p text-anchor="middle" x="' + (settings.textX != null ? settings.textX : '100') + '" y="' + (settings.textY != null ? settings.textY : '115') + '" style="' + settings.textStyle + '" fill="' + settings.textColor + '">' + settings.text + '</p>';
                    } else if (settings.multiPercentage == 1) {
                        elements += '<p text-anchor="middle" x="' + (settings.textX != null ? settings.textX : '228') + '" y="' + (settings.textY != null ? settings.textY : '65') + '" style="' + settings.textStyle + '" fill="' + settings.textColor + '">' + settings.text + '</p>';
