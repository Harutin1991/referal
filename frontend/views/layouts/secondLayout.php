                                ...
                                <ul>
                                    ...
                                    <li> 
                                        <a href="/<?= Yii::$app->language ?>/about" data-subcategories="1" class="<?php echo ($currentUrl == '/about') ? 'active' : ''; ?>">
                                            About us</a></li>
                                    <li><a href="/<?= Yii::$app->language ?>/product/" class="<?php echo ($currentUrl == '/product') ? 'active' : ''; ?>"><?=Yii::t('app','Products')?></a></li>
                                    ...
                                    <li><a href="javascript:void(0)" class="contact">Contacts</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
