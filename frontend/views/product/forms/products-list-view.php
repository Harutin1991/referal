                ...
                <div class="col-lg-4 col-md-3 col-sm-3">
                    <div class="row">
                        <div class="product_list_thumb">
                            <a href="<?php echo Url::to(['product/view', 'id' => $model['id']]) ?>"><?php echo  Html::img(Yii::$app->params['adminUrl'].'uploads/images/thumbnail/'. $model['image']); ?></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row list_shop_by">
                        <?php foreach ($model['package'] as $k => $pack) { ?>
                                <div class="price_package col-md-12 col-sm-12 col-xs-12 pd0">
                                    ...
                                    <div class="shopping_by"><?php echo $pack['title'] ?>
                                        <span class="">
