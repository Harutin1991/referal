...
<?php
$file = Files::find()->where(['category' => 'blog', 'category_id' => $blog[0]['blog_id']])->count();
if ($file) {
    echo Files::getImagesToFront('blog', $blog[0]['blog_id'], 'img-responsive', $blog[0]['title'], 1);
}
?>
            ...
            <div class="description">
                <div class="goback">
                    <a href="/<?= Yii::$app->language ?>/blog">
                        <i class="fa fa-long-arrow-left" aria-hidden="true"></i><?=Yii::t('app','Back to Blog')?>
                    </a>
                </div>
                <div class="title"><?= Html::encode($this->title) ?></div>
                <div class="dateSee">
